...
// import { listenToMessages, MessagePayload } from '../utils/messageBus';
...
//       eventBus.emit('componentSelected', component);
//     },
...
//       eventBus.emit('zoomCanvas', zoomDirection);
//       return false;
//     };

//     window.addEventListener('message', handleMessage);
//     const unsubscribe = listenToMessages(handleParentMessage);
...
//       // 向父窗口同步样式更新
//       eventBus.emit('updateComponentStyle', { componentId, styleUpdates });
//     };
...
//       // 向父窗口同步样式更新
//       eventBus.emit('updateComponentProps', { componentId, propsUpdates });
//     };

//     const handleComponentStyleUpdateWrapper = (data: { componentId: number; styleUpdates: Record<string, string> }) => {
//       handleComponentStyleUpdate(data.componentId, data.styleUpdates);
//     };

//     const handleComponentPropsUpdateWrapper = (data: { componentId: number; propsUpdates: Record<string, number | number[] | string | string[] | undefined> }) => {
//       handleComponentPropsUpdate(data.componentId, data.propsUpdates);
//     };

//     eventBus.on('updateComponentStyle', handleComponentStyleUpdateWrapper);
//     eventBus.on('updateComponentProps', handleComponentPropsUpdateWrapper);
//     return () => {
//       eventBus.off('updateComponentStyle', handleComponentStyleUpdateWrapper);
//       eventBus.off('updateComponentProps', handleComponentPropsUpdateWrapper);
//     };
//   }, []);
